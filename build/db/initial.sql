...
DROP TABLE IF EXISTS `item_item_properties`;
...
DROP TABLE IF EXISTS `item_property_possible_values`;
...
DROP TABLE IF EXISTS `item_property_types`;
...
DROP TABLE IF EXISTS `item_property_values`;
