...
CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, dateCreated DATETIME NOT NULL, itemType_id INT DEFAULT NULL, itemState_id INT DEFAULT NULL, INDEX IDX_1F1B251E753B2743 (itemType_id), INDEX IDX_1F1B251E83BB99BE (itemState_id), INDEX IDX_1F1B251E166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB;
